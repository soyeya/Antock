const headerEvet = () => {
    ...
    let headerWrap = document.querySelector(".headerWrappers");
    let htmlFilePath = '/Antock/header.html'; // 삽입할 HTML 파일 경로
    ...
    if (xhr.readyState == 4) {
        if (xhr.status == 200){
             ...
             try{
                   headerWrap.innerHTML = xhr.responseText;
                   let headerscripts = headerWrap.getElementsByTagName('script');
